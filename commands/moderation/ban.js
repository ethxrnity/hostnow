...
module.exports = {
  name: "ban",
  category: "moderation",
  description: "Zabanuje označeného uživatele",
...
if(!user) return message.channel.send({embed: {
  color: 161240,
  description: "<a:Denied_Mark:752129489617682552> Označ uživatele kterého chceš zabanovat a příkaz pošli znovu!",
  timestamp: new Date(),
    footer: {
      icon_url: message.author.avatarURL,
      text: "Požadavek od: " + message.author.username
...
let banlog = new RichEmbed()
.setTitle("Uživatel byl zabanován!")
.setThumbnail(member.user.displayAvatarURL)
.setColor("#0275d8")
.addField("Banovaný uživatel:", `${user}`)
